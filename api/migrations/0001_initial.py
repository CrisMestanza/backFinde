# Generated by Django 5.2.13 on 2026-05-05 01:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Categorias',
            fields=[
                ('idcategorias', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.ImageField(blank=True, null=True, upload_to='eventos/')),
                ('nombre', models.CharField(blank=True, max_length=60, null=True)),
                ('idevento', models.ForeignKey(blank=True, db_column='idevento', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.evento')),
            ],
            options={
                'db_table': 'imagenes',
            },
